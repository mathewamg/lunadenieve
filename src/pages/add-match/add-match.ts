...
export class AddMatchPage {
  ...
  createMatch() {
    ...
    //this.members.push(this.DbApiService.getCurrentUser().uid);
    this.members = [this.DbApiService.getCurrentUser().uid];
    ...
    this.DbApiService.addMatch(this.match, this.image, this.longitude, this.latitude, this.members);
